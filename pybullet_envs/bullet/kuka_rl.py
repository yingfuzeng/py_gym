...
class Kuka:
  ...
  def endEffectControl(self, target):
  ...
  def gripperControl(self,fingerAngle):
      p.setJointMotorControl2(self.kukaUid,
                              8,
                              p.POSITION_CONTROL,
  ...
  def current_orientation(self):
      return p.getLinkState(self.kukaUid, self.kukaEndEffectorIndex+1)[1]
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      # # self.endEffectorPos[0]= actualEndEffectorPos[0]
      # self.endEffectorPos[1] = actualEndEffectorPos[1]
      # self.endEffectorPos[2] = actualEndEffectorPos[2]
